...
namespace AR
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            Hero_Atack.Interval = Convert.ToInt32(Hero.GetSpeed());
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            try
            {
                if (curloc.botlist[0].hp <= 0)
                {
                    ...
                    Hero.GetExp(curloc.botlist[0].GetExpReward());
                    Hero.LVLUP();
                    Hero.money += curloc.botlist[0].GetMoneyReward();
        ...
        private void Enemy_Atack_Tick(object sender, EventArgs e)
        {
            try
            {
                Hero.PTakeDamage(curloc.botlist[0].GetDMG());
                listBox2.TopIndex = listBox2.Items.Add(string.Format(" {0} поймал маслину , осталось {1} ХП!", Hero.name, Hero.hp));
            }
            catch
            {
